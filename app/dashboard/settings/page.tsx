    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-20">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-gray-400 mt-1">تخصيص الواجهة، الخصوصية، والأداء</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <div className="flex items-center gap-3 border-b border-white/10 pb-4">
            ...
            <h2 className="text-xl font-bold text-white">إعدادات عامة (General)</h2>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex gap-2">
                <button 
                  ...
                  className={`flex-1 py-2 rounded-xl border transition-all ${settings.language === 'ar' ? 'bg-blue-600 border-blue-500 text-white' : 'bg-white/5 border-white/10 text-gray-400 hover:bg-white/10'}`}
                >
                  عربي
                </button>
                <button 
                  onClick={() => updateSettings({ language: 'en' })}
                  className={`flex-1 py-2 rounded-xl border transition-all ${settings.language === 'en' ? 'bg-blue-600 border-blue-500 text-white' : 'bg-white/5 border-white/10 text-gray-400 hover:bg-white/10'}`}
                >
                  English
                </button>
              </div>
            ...
            <div>
              ...
              <select 
                ...
                className="w-full bg-black/20 border border-white/10 rounded-xl py-2.5 px-4 text-white focus:outline-none focus:border-blue-500/50"
              >
            ...
            <div>
              ...
              <div className="flex gap-2">
                ...
                <button 
                  ...
                  className={`flex-1 py-2 rounded-xl border transition-all flex items-center justify-center gap-2 ${settings.cardShape === 'square' ? 'bg-blue-600 border-blue-500 text-white' : 'bg-white/5 border-white/10 text-gray-400 hover:bg-white/10'}`}
                >
                  <Square className="w-4 h-4" /> مربعة
                </button>
              </div>
            </div>
          </div>
