  ...
  return (
    <header className="h-16 relative flex items-center justify-between px-4 md:px-6 z-20 shadow-[0_4px_30px_rgba(0,0,0,0.5)] border-b border-white/5">
      ...
      <div className="absolute inset-0 overflow-hidden z-0 bg-[#0a0f1a]/90 backdrop-blur-[27px]">
        {nameplate && (
          <div className="absolute inset-0 opacity-30">
            <CachedImage src={nameplate} alt="Nameplate" fill className="object-cover" />
      ...
      <div className="flex items-center gap-3 relative z-10" ref={dropdownRef}>
        <div 
          className="flex items-center gap-3 cursor-pointer hover:bg-white/5 p-1.5 pr-4 rounded-full transition-colors border border-transparent hover:border-white/10"
        ...
        <AnimatePresence>
          {dropdownOpen && (
            <motion.div
              ...
              className="absolute top-full right-0 mt-2 w-48 bg-[#111827] border border-white/10 rounded-2xl shadow-2xl overflow-hidden py-2 z-50"
            >
              <button
                onClick={() => {
                  setDropdownOpen(false);
                ...
                className="w-full px-4 py-2.5 text-right flex items-center gap-3 text-gray-300 hover:text-white hover:bg-white/5 transition-colors"
              >
              ...
              <button
                ...
                className="w-full px-4 py-2.5 text-right flex items-center gap-3 text-red-400 hover:text-red-300 hover:bg-red-500/10 transition-colors"
              >
